...
Setelah model PSM terbentuk, misalkan kita ingin mengetahui persepsi responden apabila produk diberi harga 6000, sebagai berikut:
...
Dari tabel tersebut, dapat diinterpretasikan sebagai berikut:

- *ecdf_toocheap*: Harga barang <= 6000 tergolong **terlalu murah** bagi 1.3% responden.
- *ecdf_cheap*: Harga barang <= 6000 tergolong **murah** bagi 40.8% responden.
- *ecdf_expensive*: Harga barang >= 6000 tergolong **mahal** bagi 9.8% responden .
- *ecdf_tooexpensive*: Harga barang >= 6000 tergolong **terlalu mahal** bagi 0.4% responden .
- *ecdf_not_cheap*: Harga barang >= 6000 tergolong **tidak murah** bagi 59.1% responden. 
- *ecdf_not_expensive*: Harga barang >= 6000 tergolong **tidak mahal** bagi 90.1% responden.


***


Dari hasil analisis tersebut di atas, kita dapat membuat estimasi gambaran harga dari produk sebagai berikut: 
...
Setelah memperoleh parameter-parameter harga tersebut, kemudian kita dapat membuatkan visualisasinya sebagai berikut:
...
Kemudian akan coba disimulasikan berapa harga yang dapat memaksimalkan pendapatan bagi perusahaan dan memaksimalkan penerimaan pada customer.
...
Harga optimum tersebut dapat dibuatkan visualisasinya sebagai berikut: 

```{r}

# Harga penerimaan maksimum
